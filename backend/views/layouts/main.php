...
<div class="wrapper">
    ...
    <header class="main-header">
        <!-- Logo -->
        <a href="<?= \Yii::$app->homeUrl ?>" class="logo"><?php echo \Yii::$app->config->getVar("SCHOOL_NAME"); ?></a>
                                ...
                                <li class="user-footer">
                                    ...
                                    <div class="pull-right">
                                        <a href="<?= \yii\helpers\Url::to(['/site/logout']) ?>"
                                           class="btn btn-default btn-flat" data-method="post">Sair</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
    ...
    <footer class="main-footer">
        Powered by <strong><a href="http://www.educatux.com.br" target="_blank">Educatux &copy; - <?= date('Y');?></a></strong>
    </footer>
</div>
<!-- ./wrapper -->
