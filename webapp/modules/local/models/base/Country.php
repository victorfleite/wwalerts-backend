...
class Country extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\webapp\modules\local\models\Region::className(), ['country_id' => 'gid']);
    }
    ...
    {
        return $this->hasMany(\webapp\modules\local\models\State::className(), ['country_id' => 'gid']);
    }
    ...
    {
        return new \webapp\modules\local\models\CountryQuery(get_called_class());
    }
}
