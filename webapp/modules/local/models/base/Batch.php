...
class Batch extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\webapp\modules\local\models\City::className(), ['batch_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\webapp\modules\local\models\Country::className(), ['batch_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\webapp\modules\local\models\Region::className(), ['batch_id' => 'id']);
    }
    ...
    {
        return $this->hasMany(\webapp\modules\local\models\State::className(), ['batch_id' => 'id']);
    }
