...
$this->params['breadcrumbs'][] = Yii::t('translation', 'triggergroupfilter');
...
<div class="trigger-group-filter-view">
    ...
    <p class='text-right'>
	<?= Html::a(Yii::t('translation', 'Update'), ['update', 'trigger_id' => $model->trigger_id, 'group_id' => $model->group_id], ['class' => 'btn btn-primary']) ?>
	<?=
	Html::a(Yii::t('translation', 'Delete'), ['delete', 'trigger_id' => $model->trigger_id, 'group_id' => $model->group_id], [
